...
const options = {
  method: 'GET',
  url: 'https://deep-index.moralis.io/api/v2/nft/0x1232f87b504939d5f557dB0320B13532a4b203c0/3/transfers',
            ...
            <div className={Style.NFTDescription_box_profile_box_left}>
              ...
              <div className={Style.NFTDescription_box_profile_box_left_info}>
                ...
                <Link href={{ pathname: "/author", query: `${nft.seller}` }}>
                  <span>
                  {nft.owner.toLowerCase()} <MdVerified />
                  </span>
                </Link><br />
                <small>Seller</small> <br />
                <Link href={{ pathname: "/author", query: `${nft.seller}` }}>
                  <span>
                  {nft.seller.toLowerCase()} <MdVerified />
                  </span>
                </Link>
              </div>
            </div>
          ...
          <div className={Style.NFTDescription_box_profile_biding}>
            ...
            <div className={Style.NFTDescription_box_profile_biding_box_button}>
              ...
              <Button
                ...
                handleClick={() =>
                  router.push(
                    `/makeoffer?id=${nft.tokenId}&tokenURI=${nft.tokenURI}&price=${nft.price}`
                  )
                }
                classStyle={Style.button}
              />
