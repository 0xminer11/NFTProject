...
const UploadCollection = ({ createNFTCollection }) => {
  ...
  const [royaltowner, setRoyaltyOwner] = useState("");
  ...
  return (
    <div className={Style.upload}>
      ...
      <div className={Style.upload_box}>
        ...
        <div className={formStyle.Form_box_input}>
          <label htmlFor="nft">RoyaltyOwner</label>
          <input
            type="text"
            placeholder=""
            className={formStyle.Form_box_input_userName}
            onChange={(e) => setRoyaltyOwner(e.target.value)}
            required
          />
        </div>
      ...
      <div className={formStyle.Form_box_input}>
        ...
        <div className={Style.Radio_btns}>
          <label className={Style.royalties}>Royalities</label>
